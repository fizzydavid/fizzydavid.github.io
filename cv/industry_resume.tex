% Manually maintained industry resume. No generated fragments or build pipeline.
\documentclass[11pt,letterpaper]{article}

\usepackage[T1]{fontenc}
\usepackage{lmodern}
\usepackage[top=0.58in,bottom=0.58in,left=0.70in,right=0.70in]{geometry}
\usepackage{enumitem}
...
\newcommand{\ressection}[1]{%
  ...
  \vspace{3pt}{\color{rulecolor}\hrule height 0.5pt}\vspace{5pt}
}

\newcommand{\publication}[3]{%
  \item \textbf{#1}\enspace{\color{accent}\textbf{#2}}\par
...
\ressection{Projects}
\textbf{FizzyProver} \hfill May 2026--present\par
{\color{muted}Sole developer·Multi-agent system for mathematical research}\par
\begin{itemize}[leftmargin=1.25em,topsep=3pt,itemsep=2pt,parsep=0pt]
...
\begin{itemize}[leftmargin=1.25em,topsep=2pt,itemsep=2pt,parsep=0pt]
  ...
  \item National Olympiad in Informatics 2018, Gold Medal.

  % \item \textbf{NAC25.} ICPC North America Championship, 2nd place, Silver Medal.
  % \item \textbf{WF .} 46th ICPC World Finals, 10th place, Bronze Medal.
  % \item \textbf{IOI 2019.} International Olympiad in Informatics, 5th place, Gold Medal.
  % \item \textbf{NOI18.} National Olympiad in Informatics, Gold Medal.
\end{itemize}
\vspace{3pt}
...
\begin{enumerate}[label={[\arabic*]},leftmargin=2.1em,topsep=4pt,itemsep=4pt,parsep=0pt]
  ...
  \publication{Memory-Sample Lower Bounds for LWE}{CRYPTO 2024}{Mingqi Lu, \textbf{Junzhao Yang}}
